...
li	t6,-1
li	a6,0
beq	t6,a6,a4 <begin_testcode+0x24>
lui	ra,0x12
...
li	t5,1
li	a5,-2047
beq	t5,a5,c4 <begin_testcode+0x44>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,4(sp)
...
li	t4,0
li	a4,-1
beq	t4,a4,cc <begin_testcode+0x4c>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,8(sp)
lui	ra,0xd
...
beq	t3,a3,110 <begin_testcode+0x90>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,12(sp)
lui	ra,0xd
...
li	s11,0
lui	a2,0x80000
beq	s11,a2,130 <begin_testcode+0xb0>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,16(sp)
auipc	sp,0x2
...
beq	s10,a1,160 <begin_testcode+0xe0>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,0(sp)
lui	ra,0xd
...
li	a0,-1
beq	s9,a0,184 <begin_testcode+0x104>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,4(sp)
...
li	s1,1
beq	s8,s1,18c <begin_testcode+0x10c>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,8(sp)
lui	ra,0xd
...
beq	s7,s0,1d4 <begin_testcode+0x154>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,12(sp)
lui	ra,0xd
...
beq	s6,t2,1f8 <begin_testcode+0x178>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,16(sp)
auipc	t2,0x2
...
beq	s5,t1,228 <begin_testcode+0x1a8>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,0(t2)
lui	ra,0xd
...
lui	s4,0x80000
li	t0,0
beq	s4,t0,248 <begin_testcode+0x1c8>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,4(t2)
...
li	tp,2047
beq	s3,tp,250 <begin_testcode+0x1d0>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,8(t2)
lui	ra,0xd
...
li	s2,-1
li	gp,-1
beq	s2,gp,294 <begin_testcode+0x214>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,12(t2)
lui	ra,0xd
...
li	a7,-2047
li	sp,1
beq	a7,sp,2b4 <begin_testcode+0x234>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,16(t2)
auipc	gp,0x2
...
li	a6,0
li	ra,0
beq	a6,ra,2dc <begin_testcode+0x25c>
lui	sp,0x12
...
li	a5,-1
nop
beqz	a5,2fc <begin_testcode+0x27c>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,4(gp)
...
li	a4,1
li	t6,-2047
beq	a4,t6,304 <begin_testcode+0x284>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,8(gp)
lui	ra,0xd
...
li	a3,0
li	t5,-1
beq	a3,t5,344 <begin_testcode+0x2c4>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,12(gp)
lui	ra,0xd
...
beq	a2,t4,368 <begin_testcode+0x2e8>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,16(gp)
auipc	sp,0x2
...
li	a1,0
lui	t3,0x80000
beq	a1,t3,390 <begin_testcode+0x310>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,0(sp)
lui	ra,0xd
...
beq	a0,s11,3b8 <begin_testcode+0x338>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,4(sp)
...
li	s10,-1
beq	s1,s10,3c0 <begin_testcode+0x340>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,8(sp)
lui	ra,0xd
...
addi	s0,s0,-1 # 7fffffff <_end+0x7fffddfb>
li	s9,1
beq	s0,s9,408 <begin_testcode+0x388>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,12(sp)
lui	ra,0xd
...
lui	s8,0x80000
addi	s8,s8,-1 # 7fffffff <_end+0x7fffddfb>
beq	t2,s8,42c <begin_testcode+0x3ac>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,16(sp)
auipc	t2,0x2
...
beq	t1,s7,458 <begin_testcode+0x3d8>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,0(t2)
lui	ra,0xd
...
beq	t0,s6,480 <begin_testcode+0x400>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,4(t2)
...
lui	tp,0x80000
li	s5,0
beq	tp,s5,488 <begin_testcode+0x408>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,8(t2)
lui	ra,0xd
...
li	s4,2047
beq	gp,s4,4cc <begin_testcode+0x44c>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,12(t2)
lui	ra,0xd
...
li	sp,-1
li	s3,-1
beq	sp,s3,4ec <begin_testcode+0x46c>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,16(t2)
auipc	gp,0x2
...
li	ra,-2047
li	s2,1
beq	ra,s2,514 <begin_testcode+0x494>
lui	sp,0x12
addi	sp,sp,939 # 123ab <_end+0x101a7>
sw	sp,0(gp)
lui	ra,0xd
...
nop
li	a7,0
beq	zero,a7,534 <begin_testcode+0x4b4>
lui	ra,0x12
addi	ra,ra,939 # 123ab <_end+0x101a7>
sw	ra,4(gp)
auipc	t0,0x2
